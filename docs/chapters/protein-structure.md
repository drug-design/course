...
??? PDB
    ...
    **Hemoprotein, PDB entry: 2HHB** 
    ...
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=2HHB) 
...
=== "gapdh"
    ![](https://media.drugdesign.org/course/protein-structure/domain_function1.png){: loading=lazy }

=== "fpg"
    ![](https://media.drugdesign.org/course/protein-structure/domain_function2.png){: loading=lazy }

??? PDB
    **PDB entry: 1GD1** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1GD1) 
...
=== "Secondary"
    ![](https://media.drugdesign.org/course/protein-structure/new_look1.png){: loading=lazy }

=== "Super-Secondary"
    ![](https://media.drugdesign.org/course/protein-structure/new_look2.png){: loading=lazy }

=== "Domain"
    ![](https://media.drugdesign.org/course/protein-structure/new_look3.png){: loading=lazy }

=== "Tertiary"
    ![](https://media.drugdesign.org/course/protein-structure/new_look4.png){: loading=lazy }
...
=== "Super-Secondary"
    ![](https://media.drugdesign.org/course/protein-structure/blurred1.png){: loading=lazy }

=== "Domain"
    ![](https://media.drugdesign.org/course/protein-structure/blurred2.png){: loading=lazy }

=== "Tertiary"
    ![](https://media.drugdesign.org/course/protein-structure/blurred3.png){: loading=lazy }

??? PDB
    **PDB entry: 1R1R** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1R1R) 
    
    **DB entry: 1KYQ** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1KYQ) 
...
??? Abstract "articles"
    ...
    **Catching a Common Fold** 
    Blundell TL and Johnson MS 
    Protein Sci. 
    2 1993  
    
    **The Classification and Origins of Protein Folding Patterns** 
    Chothia C and Finkelstein AV 
    Annu. Rev. Biochem. 
    59 1990  
    
    **Identification of Homology in Potein Structure Classification** 
    Dietmann S and Holm L 
    Nat. Struct. Biol. 
    8 2001  
    
    **Identification of Tertiary Structure Resemblance in Proteins Using a Maximal Common Subgraph Isomorphism Algorithm** 
    Grindley HM, Artymiuk PJ, Rice DW, and Willett P 
    J. Mol. Biol. 
    229 1993  
    ...
    **Identifying and Classifying Protein Fold Families** 
    Orengo C, Flores TP, Taylor WR, Thornton JM 
    Protein Eng. 
    6 1993  
    
    **CATH- A Hierarchic Classification of Protein Domain Structures** 
    Orengo CA, Michie AD, Jones S, Jones DT, Swindells, MB, and Thornton JM 
    Structure 
    5 1997  
    
    **Molecular Recognition in Protein Families: a Database of Three-Dimensional Structures of Related Proteins** 
    Overington JP, Zhu ZY, Sali A, Johnson MS, Sowdhamini R, Louie C, and Blundell TL 
    Biochem. Soc. Trans. 
    21 1993  
    
    **Assigning Genomic Sequences to CATH** 
    Pearl FMG, Lee D, Bray JE, Sillitoe I, Todd AE, Harrison AP, Thornton JM, and Orengo CA 
    Nuc. Acids Res. 
    28 2000  
    
    **A Data Bank Merging Related Protein Structures and Sequences** 
    Pascarella S and Argos P 
    Protein Eng. 
    5 1992  
    ...
    **The Definition of General Topological Equivalence in Protein Structures: a Procedure Involving Comparison of Properties and Relationships through Simulated Annealing and Dynamic Programming** 
    Sali A and Blundell TL 
    J. Mol. Biol. 
    212 1990  
    
    **Protein Structure Alignment** 
    Taylor WR and Orengo CA 
    J. Mol. Biol. 
    208 1989  
...
![](https://media.drugdesign.org/course/protein-structure/fold_diversity.png){: loading=lazy }

??? PDB
    **PDB entry: 1AVD** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1AVD) 
    
    **PDB entry: 1EI5** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1EI5) 
    
    **PDB entry: 1JMX** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1JMX) 
...
![](https://media.drugdesign.org/course/protein-structure/protein_fold_and_function.png){: loading=lazy }
...
??? PDB
    ...
    **PDB entry: 2ST1** 
    ...
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=2ST1) 
...
=== "Up and Down Bundle"
    ![](https://media.drugdesign.org/course/protein-structure/mainly_alpha1.png){: loading=lazy }

=== "Orthogonal Bundle"
    ![](https://media.drugdesign.org/course/protein-structure/mainly_alpha2.png){: loading=lazy }

=== "Horseshoe"
    ![](https://media.drugdesign.org/course/protein-structure/mainly_alpha3.png){: loading=lazy }
...
??? Abstract "articles"
    ...
    **Four Helix Bundle Diversity in Globular Proteins** 
    Harris NL, Presnell SR, and Cohen FE 
    J. Mol. Biol. 
    236 1994  
...
??? PDB
    ...
    **PDB entry: 3HDD** 
    ...
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=3HDD) 
    
    **PDB entry: 1I7W** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1I7W) 
...
=== "Sandwich"
    ![](https://media.drugdesign.org/course/protein-structure/mainly_beta1.png){: loading=lazy }

=== "Barrel"
    ![](https://media.drugdesign.org/course/protein-structure/mainly_beta2.png){: loading=lazy }

=== "Propellor"
    ![](https://media.drugdesign.org/course/protein-structure/mainly_beta3.png){: loading=lazy }

=== "Trefoil"
    ![](https://media.drugdesign.org/course/protein-structure/mainly_beta4.png){: loading=lazy }


??? Abstract "articles"
    **Relative Orientation of Close-Packed beta-Pleated Sheets in Proteins** 
    Chothia C and Janin J 
    Proc. Natl. Acad. Sci. USA 
    78 1981  
    ...
    **Twisted Hyperboloid (Strophoid) as a Model of beta-Barrels in Proteins** 
    Novotny J, Bruccoleri RE, and Newell J 
    J. Mol. Biol. 
    177 1984  
...
??? PDB
    **PDB entry: 1IGT** 
    ...
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1IGT) 
    ...
    **PDB entry: 2FGF** 
    ...
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=2FGF) 
...
=== "Barrel"
    ![](https://media.drugdesign.org/course/protein-structure/mixed_alpha_beta1.png){: loading=lazy }

=== "Sandwich &alpha;&beta;&alpha;"
    ![](https://media.drugdesign.org/course/protein-structure/mixed_alpha_beta2.png){: loading=lazy }

=== "Roll"
    ![](https://media.drugdesign.org/course/protein-structure/mixed_alpha_beta3.png){: loading=lazy }

=== "Sandwich &alpha;&beta;"
    ![](https://media.drugdesign.org/course/protein-structure/mixed_alpha_beta4.png){: loading=lazy }
...
??? Abstract "articles"
    **Analysis and Prediction of the Packing of alpha-Helices against a beta-Sheet in the Tertiary Structure of Globular proteins** 
    Cohen FE, Sternberg MJE, and Taylor WR 
    J. Mol. Biol. 
    156 1982  
...
??? PDB
    ...
    **PDB entry: 6ADH** 
    ...
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=6ADH) 
    
    **PDB entry: 1UBI** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1UBI) 
    
    **PDB entry: 5ENL** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=5ENL) 
...
=== "dimer"
    ![](https://media.drugdesign.org/course/protein-structure/dimer.png){: loading=lazy }

=== "tetradecamer"
    ![](https://media.drugdesign.org/course/protein-structure/tetradecamer.png){: loading=lazy }
...
??? PDB
    ...
    **PDB entry: 1KP8** 
    ...
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1KP8) 
...
=== "C2"
    ![](https://media.drugdesign.org/course/protein-structure/homo_1.png){: loading=lazy }

=== "C5"
    ![](https://media.drugdesign.org/course/protein-structure/homo_2.png){: loading=lazy }

=== "D2"
    ![](https://media.drugdesign.org/course/protein-structure/homo_3.png){: loading=lazy }

=== "D4"
    ![](https://media.drugdesign.org/course/protein-structure/homo_4.png){: loading=lazy }
...
??? PDB
    ...
    **PDB entry: 1SAC** 
    ...
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1SAC) 
...
![](https://media.drugdesign.org/course/protein-structure/hetero_oligo.png){: loading=lazy }

??? PDB
    **PDB entry: 1E79** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1E79) 
...
![](https://media.drugdesign.org/course/protein-structure/hydro_surface.png){: loading=lazy }
...
![](https://media.drugdesign.org/course/protein-structure/hydrophobic_effect.png){: loading=lazy }
...
??? Abstract "articles"
    ...
    **Refinements of the Fluid-Mosaic Model of Membrane Structure** 
    Israelachvili J 
    ...
    **Mattress Model of Lipid Protein Interactions in Membranes** 
    Mouritsen OG and Bloom M 
    Biophys. J. 
    36 1984  
    
    **The Prediction of Amphiphilic alpha-Helices** 
    Phoenix DA, Harris F, Daman OA, and Wallace J 
    Curr. Protein. Pept. Sci. 
    3 2002  
    
    **Hydrophobic Organization of Membrane Proteins** 
    Rees DC, DeAntonio L. and Eisenberg D 
    Science 
    245 1989  
...
=== "Phospholipid"
    ![](https://media.drugdesign.org/course/protein-structure/12_3_1_1_1.png){: loading=lazy }
=== "Phospholipid bilayer"
    ![](https://media.drugdesign.org/course/protein-structure/phospholipid_bilayer.png){: loading=lazy }


??? Abstract "articles"
    **Adhesion Forces of Lipids in a Phospholipid Membrane Studied by Molecular Dynamics Simulations** 
    Marrink SJ, Berger O, Tieleman DP, and Jaehnig F 
    Biophys. J. 
    74 1998  
...
![](https://media.drugdesign.org/course/protein-structure/transmembrane.png){: loading=lazy }

??? PDB
    **PDB entry: 1E0P** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1E0P) 
...
=== "alpha-helices"
    ![](https://media.drugdesign.org/course/protein-structure/transmembrane_fold1.png){: loading=lazy }

=== "beta-barrel"
    ![](https://media.drugdesign.org/course/protein-structure/transmembrane_fold2.png){: loading=lazy }
...
??? PDB
    ...
    **PDB entry: 2POR** 
    ...
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=2POR) 
...
![](https://media.drugdesign.org/course/protein-structure/collagen.png){: loading=lazy }

??? PDB
    **PDB entry: 1BKV** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=1BKV) 
...
![](https://media.drugdesign.org/course/protein-structure/alpha_keratin.png){: loading=lazy }

??? PDB
    **PDB entry: 2TMA** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=2TMA) 
...
![](https://media.drugdesign.org/course/protein-structure/silk.gif){: loading=lazy }

??? PDB
    **PDB entry: 2SLK** 
     
    [](http://www.rcsb.org/pdb/cgi/explore.cgi?pdbId=2SLK) 
...
![](https://media.drugdesign.org/course/protein-structure/fascinating_field.png){: loading=lazy }
