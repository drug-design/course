...
<button  class='playb' onclick='playAudio(this)' data-mp3-name='3d-database-searching-case-studies/browser-non-peptidic-cyclophilin-ligands-70c0d3c4'><i class='fa fa-play' aria-hidden='true'></i></button>
