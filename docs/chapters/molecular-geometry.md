...
<button  class='playb' onclick='playAudio(this)' data-mp3-name='molecular-geometry/conformation-definition-aa316f10'><i class='fa fa-play' aria-hidden='true'></i></button>Molecules are dynamic structures and can change their geometries. An individual geometry is called a conformation and a molecule consists of a set of conformers in 3D.
