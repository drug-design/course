...
The 3D representations appear as soon as you click on the fragment you want to visualize. Then you can click on the 3D representation with the mouse in order to rotate the fragment.
...
![](https://media.drugdesign.org/course/molecular-geometry/film.gif){: loading=lazy }


??? Abstract "articles"
    **Conformational Energy Calculations on Polypeptides and Proteins** 
    Vasquez M, N{eacute}methy G and Scheraga HA 
    Chem. Rev. 
    94 1994  
...
A system of three consecutive bonds 1-2, 2-3, 3-4 defines two half-planes (1-2, 2-3) and (2-3, 3-4) intersecting along the central bond 2-3. The torsion angle &Phi; (1-2-3-4) is the angle between these two half-planes. It gives an accurate description of the relative position of the two vicinal bonds 1-2 and 3-4.
*[ee]: stands for "enantiomeric excess". A quantity for measuring the optical purity and represents the percentage of the major enantiomer minus the percentage of the minor enantiomer
