...
var chapter = "drug-design";

var molecule_id = "estradiol";
...
var modelControl_0 = {
    id: 'Estradiol (Steroid)',
    label: 'Estradiol (Steroid)',
    checked: true,
...
var modelControl_1 = {
    id: 'Mimic Molecule',
    label: 'Mimic Molecule',
    checked: true,
    sele: '/0 and not hydrogen',
    type: 'licorice',
    color: 'rgb(169, 154, 122)',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
    surface_type: 'av'
};
