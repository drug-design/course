...
var modelControls = [
    ...
    { id: 'id-0', label: 'Captopril',  checked: true,   sele: '/2' },
    { id: 'id-1', label: 'Pharmacophore',    checked: true,  sele: '/3' },
    { id: 'id-2', label: 'tetrahydro. (Design)',  checked: true,  sele: '/0' }, 
    { id: 'id-3', label: 'indoline deriv. (Design)', checked: true,  sele: '/1' },   
];
...
stage.loadFile("./../../molecules/pharmacophore-examples/browser-for-ace-inhibition.mol2").then(function (o) {
  loadedMolecule = o;
