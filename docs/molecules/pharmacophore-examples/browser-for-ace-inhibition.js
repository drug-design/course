...
var rotation = "[3.1,0.5,1.7]";

var format = "mol2";

var chapter = "pharmacophore-examples";

var molecule_id = "browser-for-ace-inhibition";
...
var modelControl_2 = {
    id: 'tetrahydro. (Design)',
    label: 'tetrahydro. (Design)',
    checked: true,
    sele: '/0',
    type: 'line',
...
var modelControl_3 = {
    id: 'indoline deriv. (Design)',
    label: 'indoline deriv. (Design)',
    checked: true,
    sele: '/1',
    type: 'line',
