...
var molecule_id = "automated-construction-approach-example";
...
var modelControl_0 = {
    id: 'Staurosporine-like',
    label: 'Staurosporine-like',
    checked: true,
...
var modelControl_1 = {
    ...
    type: 'licorice',
    color: 'skyblye',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
    surface_type: 'av'
};
