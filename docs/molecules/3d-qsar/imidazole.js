...
var distance = "1:A.H1/3-1:A.N3/4,1:A.N1/1-4:D.OH/0,1:A.H38/1-1:A.L1/5";

var format = "mol2";

var chapter = "3d-qsar";

var molecule_id = "imidazole";
...
var modelControl_0 = {
    ...
    type: 'line',
    color: 'gray',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
...
var modelControl_2 = {
    ...
    label: '3',
    checked: true,
    sele: '/3 and (not hydrogen or 1:A.H1/3)',
    type: 'line',
    color: 'element',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
...
var modelControl_4 = {
    ...
    label: '5',
    checked: true,
    sele: '/1 and (not hydrogen or 1:A.H38/1)',
    type: 'licorice',
