...
const commonRepresentations = [
  { type: "line", color: "element" }
];

var moleculeControls = [
  { index:1, id: 'peptide_bond', label: 'peptide_bond', checked: true },
  { index:2, id: 'thio', label: 'thio', checked: true },
  { index:3, id: 'depsi', label: 'depsi', checked: false },
  { index:4, id: 'thioester', label: 'thioester', checked: false },
  { index:5, id: 'ketomethylene', label: 'ketomethylene', checked: false },
  { index:6, id: 'N-methyl', label: 'N-methyl', checked: false },
  { index:7, id: 'retro-inverso', label: 'retro-inverso', checked: false },
  { index:8, id: 'reduced_amide', label: 'reduced_amide', checked: false },
  { index:9, id: 'sulfonamide', label: 'sulfonamide', checked: false },
  { index:10, id: 'phosphonamide', label: 'phosphonamide', checked: false },
  { index:11, id: 'hydroxyethylene', label: 'phosphonamide', checked: false },  
  { index:12, id: 'dihydroxyethylene', label: 'dihydroxyethylene', checked: false },
  { index:13, id: 'e-ethylene', label: 'e-ethylene', checked: false },
  { index:14, id: 'carba', label: 'carba', checked: false },
  { index:15, id: 'phosphinate', label: 'phosphinate', checked: false }
];
...
function loadMolecule(molecule) {
  return stage.loadFile("./../../molecules/peptidomimetics/bio-"+molecule.index+".sd", { label: molecule.name }).then(o => {
