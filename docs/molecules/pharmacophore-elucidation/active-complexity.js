...
var molecule_id = "active-complexity";
...
var modelControl_3 = {
    ...
    label: '4',
    checked: true,
    sele: '1:A.C9 or 1:A.C16 or 1:A.C24 or 1:A.C33 or 1:A.C15 or 1:A.C23',
    type: 'ball+stick',
    color: 'element',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
...
var modelControl_4 = {
    ...
    label: '5',
    checked: true,
    sele: '1:A.C27 or 1:A.C36 or 1:A.C43 or 1:A.C35 or 1:A.C26 or 1:A.C18',
    type: 'ball+stick',
    color: 'element',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
...
var modelControl_5 = {
    ...
    label: '6',
    checked: true,
    sele: '1:A.C38 or 1:A.C30 or 1:A.C20 or 1:A.C29 or 1:A.C37 or 1:A.C44',
    type: 'ball+stick',
    color: 'element',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
