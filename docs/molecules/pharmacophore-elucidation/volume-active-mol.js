...
var chapter = "pharmacophore-elucidation";

var molecule_id = "volume-active-mol";
...
var modelControl_9 = {
    id: 'volume inactive',
    label: 'volume inactive',
    checked: true,
    sele: '/0 or /2 or /7 or /5',
    type: 'surface',
    color: 'red',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
...
stage.loadFile("./../../molecules/"+ chapter +"/"+molecule_id+"."+format).then(function (o) {
    ...
    moleculeRepresentations.push(representation_3);
        ...
        { 
            ...
            colorScheme: modelControl_4.color_scheme,
            surfaceType: modelControl_4.surface_type, 
            lazy: true, 
            opacity: parseFloat(modelControl_4.opacity), 
    ...
    moleculeRepresentations.push(representation_8);
        ...
        { 
            ...
            colorScheme: modelControl_9.color_scheme,
            surfaceType: modelControl_9.surface_type, 
            lazy: true, 
            opacity: parseFloat(modelControl_9.opacity), 
