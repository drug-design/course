...
var rotation = "[0,0,2.0]";

var format = "mol2";

var chapter = "pharmacophore-elucidation";

var molecule_id = "nicotinic-agonists";
...
stage.loadFile("./../../molecules/"+ chapter +"/"+molecule_id+"."+format).then(function (o) {
    ...
    moleculeRepresentations.push(representation_4);
        ...
        { 
            ...
            colorScheme: modelControl_5.color_scheme,
            surfaceType: modelControl_5.surface_type, 
            lazy: true, 
            opacity: parseFloat(modelControl_5.opacity), 
