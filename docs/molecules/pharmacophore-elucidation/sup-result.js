...
var rotation = "[1.0,-0.1,1.9]";

var distance = "1:A.N8/0-1:A.N18/1,1:A.C7/0-1:A.C6/1,1:A.C6/0-1:A.C2/1";

var format = "mol2";

var chapter = "pharmacophore-elucidation";

var molecule_id = "sup-result";
...
var modelControl_2 = {
    ...
    label: '3',
    checked: true,
    sele: '1:A.N8/0 or 1:A.C7/0 or 1:A.C6/0 and not hydrogen',
    type: 'hyperball',
...
var modelControl_3 = {
    ...
    label: '4',
    checked: true,
    sele: '1:A.N18/1 or 1:A.C6/1 or 1:A.C2/1 and not hydrogen',
    type: 'hyperball',
    color: 'yellow',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
