...
var distance = "1:A.O8/0-1:A.H31/0";

var format = "mol2";

var chapter = "structure-activity-relationships";

var molecule_id = "phenoxyphenyltriazoles";
...
var modelControl_0 = {
    id: 'estazolam (reference)',
    label: 'estazolam (reference)',
    checked: true,
...
var modelControl_1 = {
    id: 'phenyl-triazole derivative (design)',
    label: 'phenyl-triazole derivative (design)',
    checked: true,
    sele: '/0 and not hydrogen or 1:A.H31/0',
    type: 'licorice',
    color: 'element',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
