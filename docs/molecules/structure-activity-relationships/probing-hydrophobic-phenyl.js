...
var rotation = "[1.5,0.0,0.0]";

var format = "mol2";

var chapter = "structure-activity-relationships";

var molecule_id = "probing-hydrophobic-phenyl";
...
var modelControl_2 = {
    id: 'Phenyl Surface',
    label: 'Phenyl Surface',
    checked: true,
    sele: '1:A.BR46/2 or 1:A.C3/2 or 1:A.C4/2 or 1:A.C5/2 or 1:A.C6/2 or 1:A.C1/2 or 1:A.C2/2 or 1:A.O4/2 or 1:A.BR48/2',
    type: 'surface',
...
var modelControl_3 = {
    id: 'Catalytic Site Surface',
    label: 'Catalytic Site Surface',
    checked: true,
    sele: '/0 and not hydrogen',
    type: 'surface',
    color: 'white',  // 'defaultColor' is a placeholder, replace with a default color if needed
...
stage.loadFile("./../../molecules/"+ chapter +"/"+molecule_id+"."+format).then(function (o) {
    ...
    moleculeRepresentations.push(representation_2);
        ...
        { 
            ...
            colorScheme: modelControl_3.color_scheme,
            surfaceType: modelControl_3.surface_type, 
            lazy: true, 
            opacity: parseFloat(modelControl_3.opacity), 
