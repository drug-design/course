...
var distance = "1:A.O43/1-1:A.H59/1";

var format = "mol2";

var chapter = "structure-activity-relationships";

var molecule_id = "salicylanilides";
...
var modelControl_0 = {
    id: 'quinazoline structure (reference)',
    label: 'quinazoline structure (reference)',
    checked: true,
...
var modelControl_1 = {
    id: 'salicylanilide scaffold (design)',
    label: 'salicylanilide scaffold (design)',
    checked: true,
    sele: '/1 and not hydrogen or 1:A.H59/1',
    type: 'licorice',
    color: 'element',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
