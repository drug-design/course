...
var distance = "1:A.O5/1-1:A.H81/1";

var format = "mol2";

var chapter = "structure-activity-relationships";

var molecule_id = "anthranilamides";
...
var modelControl_0 = {
    id: 'anilinophtalazine (reference)',
    label: 'anilinophtalazine (reference)',
    checked: true,
    sele: '/0 and not hydrogen or 1:A.H28/0',
    type: 'licorice',
...
var modelControl_1 = {
    id: 'anthranilamide (design)',
    label: 'anthranilamide (design)',
    checked: true,
    sele: '/1 and not hydrogen or 1:A.H81/1 or 1:A.H25/1',
    type: 'licorice',
    color: 'element',  // 'defaultColor' is a placeholder, replace with a default color if needed
    opacity: '0.5',
    color_scheme: 'electrostatic',
